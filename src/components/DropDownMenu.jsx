...
const DropDownMenu = ({ role, isOwnProfile }) => {
    ...
    const canEdit = isOwnProfile || role === 'admin' || role === 'lead'
    const canSuspendOrDelete = role === 'admin' || role === 'lead'
    if (role === 'intern' && !isOwnProfile) {
        return null;
    }
    return (
        ...
        <div style={{ position: 'absolute', top: '10px', right: '8px' }}>
            <div className='relative'>
                ...
                {isMenuOpen && (
                    <div className="absolute top-10 right-0 mt-2 z-50 font-medium bg-white border rounded shadow-lg transition-all ease-in duration-300" style={{ width: 'max-content' }}>
                        <div className="py-1">
